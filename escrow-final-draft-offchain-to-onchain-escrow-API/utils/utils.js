...
// async function contractParamsBuilderFcn1(id) {
//   let builtParams = [];
//     builtParams = new ContractFunctionParameters().addUint256(id);
//   return builtParams;
// }
// async function changeMsState(cId, gasLim, fcnName, params, client) {
//   console.log("Inside contractExecuteFcn")
//     const contractExecuteTx = new ContractExecuteTransaction()
//       .setContractId(cId)
//       .setGas(gasLim)
...
// }
// async function changeMsState(functionName, parameters, gas, contractId, abi, client, amountHbar) {
//   // execute the transaction
//   try {
//     const transaction = await new ContractExecuteTransaction()
//       .setContractId(contractId)
...
module.exports = {
  createByteCodeFileId, createContractFactoryContractId, contractParamsBuilderFcnMS, contractExecuteFcn,
